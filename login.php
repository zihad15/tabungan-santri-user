						...
						<option selected disabled="disabled"> -- Select Username -- </option>
							<?php				
								...
								while($row = mysqli_fetch_array($result)){
									...
									$value = base64_encode($base_path."verification.php?user_id=".$row['id']);
								
									echo "<option value=$value id='option' user_id='".$row['id']."' user_name='".$row['username']."'>$row[username]</option>";
								}				
							?>
					</select>
				</div>
